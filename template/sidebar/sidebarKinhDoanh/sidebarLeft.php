            ...
            <div class="container">
                <div class="sidebarHeader_wrapper">
                    <div class="sidebarHeader_card">
                        ...
                        <div class="sidebarHeader_content">
                            <span>Trưởng đơn vị: </span><strong>Nguyễn Thị Yến Hoa</strong>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="Số đơn hàng" class="data_chart-items">
                                        <canvas id="stackedChart_soDonHang"></canvas>
                                    </div>
